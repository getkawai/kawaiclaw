...
Examples:
  kawaiclaw model                    # Show current default model
  kawaiclaw model gpt-5.2           # Set gpt-5.2 as default
  kawaiclaw model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  kawaiclaw model local-model       # Set local VLLM server as default
